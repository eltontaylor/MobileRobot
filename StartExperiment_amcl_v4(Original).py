...
def get_xy_loc(msg):
        ...
        size_x_map = 3328 #in pixel 1728 no difference when changed
        size_y_map = 1952 #in pixel 1156 no difference when changed
        locs_x_map_origin = -31.4 #in meter   //map7.yaml parameters
        locs_y_map_origin = -23.4 #in meter  //map7.yaml parameters
...
if __name__ == '__main__':
    ...
    # Start Experiment
    Experiment(NumberOfTrials=1,
               RewardTimeOut= NumberOfTrials*40,
               Orientation=0,
