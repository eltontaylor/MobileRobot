...
def callback(data):
    ...
    global appendInfo
    global clear, stop, slowSpeed, fastSpeed

    clear = platform_clear_dist
    stop = platform_stop_dist
    slowSpeed = platform_slowDownSpeed
    fastSpeed = platform_normalSpeed

    #print("clear", clear)
    #print("stop", stop)
    #print("slowSpeed", slowSpeed)
    #print("fastSpeed", fastSpeed)
